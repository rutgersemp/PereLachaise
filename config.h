...
const uint8_t __LEGA_PWM_PIN__ = 16;
const uint8_t __LEGA_DIR_PIN__ = 17;
const float   __LEGA_ANGLE_RAD__ = 0.0;

const uint8_t __LEGB_PWM_PIN__ = 21;
const uint8_t __LEGB_DIR_PIN__ = 20;
const float   __LEGB_ANGLE_RAD__ = 0.0;

const uint8_t __LEGC_PWM_PIN__ = 27;
const uint8_t __LEGC_DIR_PIN__ = 26;
const float   __LEGC_ANGLE_RAD__ = 0.0;
